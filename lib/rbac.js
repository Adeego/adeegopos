...
const OPERATION_REQUIREMENTS = Object.freeze({
  ...
  getCashierSales: any(requirement(MODULE_IDS.POS, ACCESS_LEVELS.MANAGE), requirement(MODULE_IDS.REPORTS)), getTodaySalesByPaidStatus: any(requirement(MODULE_IDS.POS, ACCESS_LEVELS.MANAGE), requirement(MODULE_IDS.BOOKKEEPING)),
  getUnpaidSalesBeforeToday: any(requirement(MODULE_IDS.POS, ACCESS_LEVELS.MANAGE), requirement(MODULE_IDS.BOOKKEEPING)), updateSalePaidStatus: requirement(MODULE_IDS.POS, ACCESS_LEVELS.MANAGE),
  getRegisterSession: any(requirement(MODULE_IDS.POS, ACCESS_LEVELS.OPERATE), requirement(MODULE_IDS.BOOKKEEPING, ACCESS_LEVELS.MANAGE)), openRegisterSession: requirement(MODULE_IDS.POS, ACCESS_LEVELS.MANAGE), takeOverRegisterSession: requirement(MODULE_IDS.POS, ACCESS_LEVELS.MANAGE), closeRegisterSession: any(requirement(MODULE_IDS.POS, ACCESS_LEVELS.MANAGE), requirement(MODULE_IDS.BOOKKEEPING, ACCESS_LEVELS.MANAGE)),
