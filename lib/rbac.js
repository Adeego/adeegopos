...
const OPERATION_PERMISSIONS = {
  ...
  getAllSalesBetweenDates: ['pos:sell', 'report:read'],
  getFailedSalesBetweenDates: ['pos:sell', 'report:read'],
  ...
  openRegisterSession: 'cashier:manage',
  ...
  getGeneralLedger: 'finance:read',
  getFinanceLedgerHealth: 'finance:read',
  previewFinanceLedgerBackfill: 'finance:read',
  runFinanceLedgerBackfill: 'finance:write',
