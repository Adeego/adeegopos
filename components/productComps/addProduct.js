      ...
      <SheetContent className="xl:max-w-[500px]">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="baseUnit" className="text-right">Base Unit</Label>
              <Input id="baseUnit" name="baseUnit" value={newProduct.baseUnit} onChange={handleInputChange} className="col-span-3" />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="buyPrice" className="text-right">Buy Price</Label>
              <Input id="buyPrice" name="buyPrice" type="number" value={newProduct.buyPrice} onChange={handleInputChange} className="col-span-3" />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="restockThreshold" name="restockThreshold" type="number" value={newProduct.restockThreshold} onChange={handleInputChange} className="col-span-3" />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="restockPeriod" className="text-right">Restock Period (Days)</Label>
              <Input id="restockPeriod" name="restockPeriod" type="number" value={newProduct.restockPeriod} onChange={handleInputChange} className="col-span-3" />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
            ...
            <div className="py-4">
              ...
              <div className="grid grid-cols-4 gap-4 items-center">
                ...
                <Input id="variantName" name="name" value={newVariant.name} onChange={handleVariantChange} className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 gap-4 items-center">
                <Label htmlFor="conversionFactor" className="text-right">Conversion Factor</Label>
                <Input id="conversionFactor" name="conversionFactor" type="number" value={newVariant.conversionFactor} onChange={handleVariantChange} className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 gap-4 items-center">
                <Label htmlFor="variantUnitPrice" className="text-right">Unit Price</Label>
                <Input id="variantUnitPrice" name="unitPrice" type="number" value={newVariant.unitPrice} onChange={handleVariantChange} className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 gap-4 items-center">
                <Button type="button" onClick={addVariant} className="col-span-4">
                  Add Variant
                </Button>
              </div>
            </div>
              ...
              <div>
                ...
                <ul>
                  {newProduct.variants.map(variant => (
                    <li key={variant._id}>
                      {variant.name} - {variant.unitPrice} ({variant.conversionFactor})
                    </li>
                  ))}
                </ul>
              </div>
