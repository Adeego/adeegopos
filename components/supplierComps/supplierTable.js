    ...
    <Card>
      ...
      <CardFooter className="flex justify-between items-center">
        <div className="text-base text-muted-foreground">
          Showing <strong>{indexOfFirstSupplier + 1}-{Math.min(indexOfLastSupplier, filteredSuppliers.length)}</strong> of <strong>{filteredSuppliers.length}</strong> suppliers
        </div>
